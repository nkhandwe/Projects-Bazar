...
@section('title', translate('Shipping_Policy').' | '.$web_config['name']->value.' '.translate('ecommerce'))
...
@section('content')
    <main class="main-content d-flex flex-column gap-3 pb-3">
        <div class="page-title overlay py-5 __opacity-half background-custom-fit"
            ...
            <div class="container">
                <h1 class="absolute-white text-center text-capitalize">{{ translate('shipping_policy') }}</h1>
            </div>
        </div>
        <div class="container">
            <div class="card my-4">
