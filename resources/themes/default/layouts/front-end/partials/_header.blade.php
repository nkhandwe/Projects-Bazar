...
<header class="rtl __inline-10">
    <div class="topbar bg--web-primary text-light">
        <div class="container">
            ...
            <div>
                ...
                <div class="topbar-text dropdown disable-autohide  __language-bar text-capitalize">
                    ...
                    <a class="widget-list-link text-dark" href="{{ route('track-order.index') }}">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul
                                    ...
                                    <li class="__inline-17">
                                        ...
                                        <li class="__inline-17">
                                            <a class="dropdown-item" href="{{route('track-order.index')}}">
                                                {{ translate('track_order')}}
                                            </a>
                                        </li>
                                        ...
                                        @if(isset($refund_policy['status']) && $refund_policy['status'] == 1)
                                            <li class="__inline-17">
                                                <a class="dropdown-item" href="{{route('refund-policy')}}">
                                        ...
                                        @if(isset($return_policy['status']) && $return_policy['status'] == 1)
                                            <li class="__inline-17">
                                                <a class="dropdown-item" href="{{route('return-policy')}}">
                                        ...
                                        @if(isset($cancellation_policy['status']) && $cancellation_policy['status'] == 1)
                                            <li class="__inline-17">
                                                <a class="dropdown-item" href="{{route('cancellation-policy')}}">
