                ...
                <div class="col-md-3 footer-web-logo text-center text-md-start ">
                    <a class="d-block" href="{{route('home')}}">
                        <img class="{{Session::get('direction') === "rtl" ? 'right-align' : ''}}"
                            ...
                            alt="{{ $web_config['name']->value }}" style="width: 100px;!important" />
                    </a>
                    <hr class="mt-5">
                    <div class="col-md-5 mt-2 text-start">
                        <div
                            class="row d-flex align-items-center mobile-view-center-align justify-content-center justify-content-md-start pb-0">
                            <div class="d-none d-md-block">
                                <h6 class="mb-4 font-weight-bold footer-header">{{ translate('address')}}</h6>
                            </div>
                            <div
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="text-light">{{ getWebConfig(name: 'shop_address')}}</span>
                        </div>
                    </div>
                    <div
                        class="max-sm-100 mt-5 justify-content-center d-flex flex-wrap mt-md-3 mt-0 mb-md-3">
