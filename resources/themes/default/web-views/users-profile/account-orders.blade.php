                                    ...
                                    <tbody>
                                        @foreach ($orders as $order)
                                            <tr>
                                                ...
                                                <td class="bodytr">
                                                    <div class="fs-13 font">
                                                        @if ($order['payment_status'] == 'paid')
                                                            <a href="{{ route('videoView', $order->id) }}"
                                                                class="coursor-pointer btn btn-sm btn--primary status-badge text-white rounded-pill __badge badge-soft-success fs-12 font-semibold text-capitalize">
                                                                {{ 'Watch Videos' }}
                                                            </a>
                                                        @else
                                                            <span
                                                                class="coursor-pointer btn btn-sm btn--primary status-badge text-white status-badge rounded-pill __badge badge-soft-danger fs-12 font-semibold text-capitalize"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Please pay the order amount to watch the videos.
                                                            </div>
