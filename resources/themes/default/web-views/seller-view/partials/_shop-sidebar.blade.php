                                            ...
                                            <div class="for-hover-label card-header flex-between">
                                                <div>
                                                    <label class="cursor-pointer get-view-by-onclick"
                                                           data-link="{{ route('shopView', ['id'=> $seller_id, 'category_id' => $child['id'], 'data_from' => 'category', 'page' => 1]) }}">
                                                        {{$child['name']}}
                                                    </label>
                                                </div>
                                                <div class="px-2 cursor-pointer menu--caret">
                                                ...
                                                @foreach($child->childes as $ch)
                                                    <div class="card-header">
                                                        <label
                                                            ...
                                                            data-link="{{ route('shopView', ['id' => $seller_id, 'category_id' => $ch['id'], 'data_from' => 'category', 'page' => 1])}}">
                                                            {{$ch['name']}}
                                                        </label>
                                                    </div>
                                                @endforeach
