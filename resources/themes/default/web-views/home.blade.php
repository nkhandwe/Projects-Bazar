        ...
        <section class="interest-section">
            ...
            <div class="container rtl pb-4 px-max-sm-0">
                <ul class="nav nav-pills mb-3" id="categoryTabs" role="tablist">
                    ...
                    @endforeach
                    {{-- <li class="nav-item category-product-view-all">
                        <a class="text-capitalize view-all-text text-nowrap btn btn-primary"
                ...
                <div class="tab-content" id="categoryTabsContent">
                    @foreach ($categories as $key => $category)
                        <div class="tab-pane fade {{ $key === 0 ? 'show active' : '' }}" id="category-{{ $category->id }}"
                            role="tabpanel" aria-labelledby="category-tab-{{ $category->id }}">
