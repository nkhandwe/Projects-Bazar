@if(isset($product))
    ...
    <div class="flash_deal_product get-view-by-onclick card p-1 mb-3 me-2" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 8px;" data-link="{{ route('product',$product->slug) }}">
        <div>
