                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (Helpers::module_permission_check('product_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/product-faqs/*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.product-faqs.add-new') }}"
                                    title="{{ __('Product Faqs') }}">
                                    <i class="tio-mic nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ __('Product Faqs') }}</span>
                                </a>
                            </li>

                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/product-videos*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.product-videos.add-new') }}"
                                    title="{{ 'Product Videos' }}">
                                    <i class="tio-youtube nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ 'Product Videos' }}</span>
                                </a>
                            </li>
